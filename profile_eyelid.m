...
if answer{2} == '0'
    ...
    [prevCenter,maxArea,prevMask,origAngle,Xs,Ys,HSVranges] = eye_edge_adv(frROI,1,-1,-1,-1);
...
[nBlinks, blink_inds] = mark_blinks(tOdd,eyeSig_final,1,33.33);
