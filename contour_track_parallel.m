function [minor,ctr,area,contour,inBlink,isClosed] = contour_track_parallel(frame, maxArea, prevMask, prevCenter, origAngle, plotYN, inBlink, iter, zeroCenter, HSVranges, gs)
