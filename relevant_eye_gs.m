function [focusedFrame] = relevant_eye_gs(frame,HSVs)
...
frameHSV = rgb2hsv(cat(3, frame, frame, frame));
...
relPixels = valueImage > HSVs(3,1)-2*HSVs(3,2) & valueImage < HSVs(3,1) + 0.5*HSVs(3,2);
